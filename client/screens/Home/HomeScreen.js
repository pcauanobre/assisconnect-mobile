...
export default function HomeScreen({ navigation }) {
  ...
  const formattedDate = dashboardData.date
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        ...
        <InfoCard
          text="Responsável do Dia: "
          boldText={dashboardData.responsibleStaff}
        />
        <InfoCard
          text="Última sinc. às: "
          boldText={dashboardData.lastSync.toLocaleTimeString("pt-BR", {
            hour: "2-digit",
            minute: "2-digit",
          })}
        />
